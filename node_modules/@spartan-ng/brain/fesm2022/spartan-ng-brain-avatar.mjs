...
import { signal, computed, HostListener, Directive, contentChild, ViewEncapsulation, ChangeDetectionStrategy, Component, inject, ElementRef, input, Pipe, NgModule } from '@angular/core';
